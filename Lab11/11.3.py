...
for i in range(1, 925):  # Adjust the range according to your dataset
...
for i in range(0, 925):  # Adjust the range according to your dataset
...
def detect_pedestrians(image, clf, win_stride=(8, 8), scale=1.05):
    ...
    for scale_factor in np.arange(1, 2.5, 0.1):  # Adjust scale range for better detection
